...
This is the default application structure which you will get by running `yo ng-app` command with app name as `testapp`.
...
Modules allow you to more explicitly separate parts of your application.  Use the `yo ng-app:module my-module` command and specify a new subdirectory to place the module into.  Once you've created a module, running other subgenerators will now prompt you to select the module in which to place the new component.
...
Running a generator:
    ...
    yo ng-app:directive my-directive
    yo ng-app:template my-template
    yo ng-app:service my-service
    yo ng-app:controller my-controller
    yo ng-app:filter my-filter
    yo ng-app:module my-module
    yo ng-app:modal my-modal
